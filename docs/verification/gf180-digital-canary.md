...
This qualifies a generic core-flow canary only. It does not qualify the public PDK for fabrication, project RTL, pads, ATPG coverage, SDF, package-aware IR/EM, or provider precheck.
