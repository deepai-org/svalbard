...
| Autonomous clock source | A minimum-subset proof selects two complete 1.25 GHz split-control folded parents from three 0-DRC, unique-LVS, full-RC candidates. Their 293/400-case bare-bank union has two unique PEX identities and continuous target plus +/-2% design-band coverage in 5/5 environments. The routed two-DAC/two-VCO/high-gain-selector parent is independently 0-DRC, unique-LVS, and full-RC extracted; realizable 2.0 V-reference codes close 10/35 exact-parent cases and all 5/5 environments with three codes of selected rail headroom. Its live handoff passes from 1.2575 to 1.2452 GHz with 3.46 mV dead-interval residue. The older twelve-parent 2.5 GHz experiment remains failed falsification evidence | Deterministic complete-parent range, selection, shutdown, and handoff are closed. Statistical startup/mismatch, phase noise, supply/reference pushing, divider loading, calibration controller, and closed PLL remain unclosed |
