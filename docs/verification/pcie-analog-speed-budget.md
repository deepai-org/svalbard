...
| Externally clocked 2.5 GT/s lane | A separately laid out 3.6-um-load data restorer and the exact TX/termination/RX/sampler PEX stack pass 6/16 nominal phases and 5/5 representative environments. Worst selected raw-RX hold, restored, and sampler margins are 169.915, 376.508, and 137.055 mV. Nominal uses zero added UI latency; both slow/hot cases use one deterministic UI. | Required line rate is plausible through the sampler under the provisional lumped boundary. Combined channel/jitter/supply stress, mismatch, physical parent routing, recovered clock and selected I/O remain open. |
