...
| Autonomous clock source | Ten complete 1.25 GHz folded oscillator parents are independently 0-DRC, unique-LVS and full-RC PEX. Hash-bound evidence combines 183/280 valid fixed-control cases with 427/600 valid split-control cases. The realizable union has ten unique PEX identities and continuous target plus +/-2% design-band coverage in 5/5 environments. The older twelve-parent 2.5 GHz full-rate experiment is physically legal but reaches target in only 2/5 environments. The two-input selector and balanced sixteen-leaf hierarchy retain their prior full-rate isolation/handoff evidence | Bare-bank deterministic PVT range is closed. Realizable dual-bias generation/calibration, selected-bank/tree/power-control composition, statistical startup, phase noise, supply pushing, mismatch, divider loading and closed PLL remain unclosed |
