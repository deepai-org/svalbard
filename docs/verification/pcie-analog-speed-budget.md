...
| Autonomous clock source | Center plus 11 physical delay-tile variants are DRC-clean/LVS-unique/full-RC; the complete bank has aggregate +/-2% margin in 5/5 extracted environments. A matched 1 um startup-assist cell is also DRC-clean/LVS-unique/full-RC; seven sampled loaded tiles pass 42/42 no-IC, supply-ramped commanded starts and bracket 2.5 GHz in 5/5 environments | Deterministic assist is not statistical noise-startup evidence. Safe selection/inactive isolation, phase noise, supply pushing, mismatch, divider loading and the closed PLL remain unclosed |
