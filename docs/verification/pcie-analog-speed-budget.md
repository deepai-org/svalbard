...
| Externally clocked 2.5 GT/s lane | The calibrated exact-PEX leaf stack passes 5/5 representative environments under combined 6-ohm/leg + 1-pF channel, 30-ps jitter, 47% duty, and 20-mV rail-ripple stress. The first routed hierarchy places the RX amplifier, calibrated limiter, and sampler in one zero-DRC, unique-LVS, 1,309R/464C parent. Replacing their three leaf PEX instances with that exact parent retains 5/5 closure; worst pin, raw-RX, restored, converter, and final margins are 103.002 mV, 51.209 mV, 217.828 mV, 1.15809 V, and 939.439 mV at 58.830 mA maximum. The original 1/5 pre-calibration result remains preserved as failure provenance. | Complete termination-to-RX and sampler-to-converter parent routing; mismatch, extracted PDN/substrate aggression, recovered clock, and selected I/O remain open. |
