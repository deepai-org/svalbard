...
| PI-clocked 2.5 GT/s lane | The zero-DRC, unique-LVS 8,625R/5,034C parent routes the PI, two-stage clock restorer, termination, RX, limiter, sampler, converters, and split capture. TT and SS/passive extracted clock-load tests each pass 4/4 restorer biases. Corrected per-lane qualification and write scoring retains adjacent 200 and 300 ps nominal offsets and passes 3/5 exact-parent PVT cases: TT, FF/cold, and SS/passive. FF/hot and SS/hot fail at the old converter boundary before final capture. A new StrongARM-style schematic passes 10/10 targeted environments at a fixed 120 ps qualification point with 527 mV minimum logic margin and one 800 ps lane-cycle latency. | The old converter's 700--900 ps useful window is incompatible with a 400 ps serial UI. Lay out and extract the fast replacement, rebuild the routed parent, and replay PVT before autonomous-CDR composition. |
