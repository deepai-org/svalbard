...
| Externally clocked 2.5 GT/s lane | A separately laid out 3.6-um-load data restorer and the exact TX/termination/RX/sampler PEX stack pass 6/16 nominal phases and 5/5 representative environments. The full path through exact-PEX converters and capture passes nominal combined 6-ohm/leg + 1-pF channel, 30-ps jitter, 47% duty, and 20-mV rail-ripple stress. Retapering the final capture buffer closes the two fast combined-stress corners: FF/hot has 1.128 V final margin at 50.55 mA and FF/cold has 3.093 V at 57.07 mA. The original 1/5 pre-calibration result remains preserved as failure provenance. | The two slow/hot environments still require a physical TX/emphasis revision; mismatch, physical parent routing, recovered clock and selected I/O also remain open. |
