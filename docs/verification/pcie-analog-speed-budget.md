...
| PI-clocked 2.5 GT/s lane | The zero-DRC, unique-LVS 8,625R/5,034C parent routes the PI, two-stage clock restorer, termination, RX, limiter, sampler, converters, and split capture. Corrected per-lane scoring passes 3/5 exact-parent PVT cases; FF/hot and SS/hot fail at the old converter boundary. Its replacement is now independently zero-DRC, uniquely LVS-matched, and 2,172R/1,311C full-RC extracted. The replacement passes 10/10 targeted exact-PEX environments at a fixed 120 ps point with 546.42 mV minimum logic margin, 9.964 mA maximum current, and one 800 ps lane-cycle latency. | The old converter's 700--900 ps useful window is incompatible with a 400 ps serial UI. Rebuild the routed parent with the physically closed fast macro and replay PVT before autonomous-CDR composition; leaf closure does not prove parent timing. |
