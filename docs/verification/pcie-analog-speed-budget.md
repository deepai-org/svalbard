...
| Autonomous clock source | Center plus 11 physical delay-tile variants are DRC-clean/LVS-unique/full-RC; the bank has aggregate +/-2% margin in 5/5 environments and startup assist passes 42/42 no-IC commanded starts. A complete routed band parent is 0-DRC, unique-LVS, 1,210R/329C and passes 5/5 exact-PEX startup/load/shutdown cases at 2.493 GHz; its real selector load shifts frequency by 0.0137%. The two-input selector passes direct two-VCO composition. Its balanced four-stage twelve-used/four-spare hierarchy is 0-DRC, unique-LVS, 6,947R/3,061C and passes 16/16 all-leaf/PVT cases plus full-depth handoff; worst cycle jitter is 6.02 ps and worst frequency error is 0.032% | The routed result covers one nominal coarse member; deterministic assist is not statistical noise-startup evidence. Remaining band parents, twelve-band/tree/power-control composition, phase noise, supply pushing, mismatch, divider loading and closed PLL remain unclosed |
