...
| Externally clocked 1.25 GBd lane | Selected TX PEX plus explicit AC coupling/package/bias boundary and fresh termination/RX/sampler PEX passes 13/16 nominal phases and the selected phase in 5/5 environments. Two exact-PEX CML-to-CMOS converters and a compacted zero-DRC/unique-LVS 2,202R/1,570C split-clock capture extend it to stable parallel CMOS in 4/4 nominal offsets and 5/5 environments, with 2.363 V worst PVT final margin. A 64-bit PRBS7-prefix stress passes 4/4 exact-PEX cases and 224/224 scored bits across baseline, a 6-ohm/leg + 1-pF differential RC proxy, 40-ps peak TX jitter with 47% duty, and combined stress. | Deterministic full path under one provisional channel; denser combined PVT/impairment sweeps, aggressors and selected pad/package/S-parameter models remain |
