...
| Externally clocked 1.25 GBd lane | The exact TX/termination/RX/sampler/converter/capture path now includes a dedicated 0-DRC, unique-LVS, 366R/92C data restorer at the previously violated sampler boundary. One exact stack passes 5/5 environments and 160/160 scored PRBS bits under simultaneous 6-ohm/leg + 1-pF RC channel stress, 30-ps peak jitter, 47% duty, and 20-mV/100-MHz rail ripple. Worst restored and final margins are 230.118 mV and 2.73372 V. | Bounded low-loss full path; mismatch, extracted aggressors, equivalent combined stress at 2.5 GT/s, and selected pad/package/S-parameter models remain |
| Externally clocked 2.5 GT/s lane | A separately laid out 3.6-um-load data restorer and the exact TX/termination/RX/sampler PEX stack pass 6/16 nominal phases and 5/5 representative environments. The full path through exact-PEX converters and the 2,202R/1,570C capture parent passes nominal combined 6-ohm/leg + 1-pF channel, 30-ps jitter, 47% duty, and 20-mV rail-ripple stress with 763.159 mV final margin. The preserved pre-calibration PVT replay passes only 1/5 and localizes four distinct mechanisms. | Required line rate is plausible through final capture nominally, not yet across combined-stress PVT. Converter scheduling, current, mismatch, physical parent routing, recovered clock and selected I/O remain open. |
