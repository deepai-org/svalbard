...
| Autonomous clock source | Five 54 x 56 um physical tile geometries; four added variants are DRC-clean/LVS-unique/full-RC. Center+slow+fast cover 3/5 extracted environments; slow spans 2.447--2.542 GHz and fast 2.478--2.543 GHz in their target corners | SS at 2.97 V/125 C remains short: 2.395 GHz ultra-fast and 2.358 GHz high-gain maxima. Active redesign, selectable bank, unseeded startup, phase noise, supply pushing, divider and PLL remain unclosed |
