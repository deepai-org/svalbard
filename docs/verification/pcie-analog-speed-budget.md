...
| Autonomous clock source | Center plus 11 physical delay-tile variants are DRC-clean/LVS-unique/full-RC; the complete bank has aggregate +/-2% margin in 5/5 extracted environments. The physical startup assist passes 42/42 no-IC commanded starts. Reused PI geometry closes as a 2.5 GHz two-input selector: 5/5 calibrated environments, extracted nonoverlap handoff, and 5/5 nonlinear two-VCO cases with -30.76 dB worst powered-down feedthrough | Deterministic assist is not statistical noise-startup evidence. The complete twelve-band selector hierarchy/interconnect, phase noise, supply pushing, mismatch, divider loading and closed PLL remain unclosed |
