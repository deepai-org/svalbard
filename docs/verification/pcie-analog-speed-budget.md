...
| Externally clocked 1.25 GBd lane | The exact TX/termination/RX/sampler/converter/capture path includes a dedicated 0-DRC, unique-LVS, 366R/92C data restorer and the retapered 1,957R/1,400C capture cell. One exact stack passes 5/5 environments and 160/160 scored PRBS bits under simultaneous 6-ohm/leg + 1-pF RC channel stress, 30-ps peak jitter, 47% duty, and 20-mV/100-MHz rail ripple. Worst restored and final margins are 230.118 mV and 2.80740 V. | Bounded low-loss full path; mismatch, extracted aggressors, and selected pad/package/S-parameter models remain |
| Externally clocked 2.5 GT/s lane | The routed hierarchy now includes termination, RX, calibrated limiter, sampler, both CML-to-CMOS converters, split capture, and all intervening data/capture-clock routes in one zero-DRC, unique-LVS, 7,900R/4,804C parent. Its exact PEX passes 5/5 representative environments under combined 6-ohm/leg + 1-pF channel, 30-ps jitter, 47% duty, and 20-mV rail-ripple stress. Worst pin, raw-RX, restored, converter, and final margins are 104.176 mV, 47.052 mV, 209.582 mV, 558.084 mV, and 623.576 mV at 52.203 mA maximum. Final output is valid by 750 ps, leaving 50 ps before the next 800 ps same-interleave event. The original 1/5 pre-calibration result remains preserved as failure provenance. | The core receive data path is physically composed through capture. Mismatch/metastability, realized upstream clock/bias trees, extracted PDN/substrate aggression, recovered clock, and selected I/O remain open. |
| PI-clocked 2.5 GT/s lane | The fast-converter hierarchy routes the PI, two-stage clock restorer, termination, RX, limiter, sampler, both converters, and split capture in one zero-DRC, unique-LVS 8,717R/4,874C parent. Its exact PEX passes 4/5 representative 24-bit combined-stress environments; the limiting passing final margin is 685.201 mV in FF/hot, with 22.95 mV sampler overshoot inside a 50 mV bound. SS/hot remains failed because even and odd lanes carry the requested word at different integer data ages. The 2,087R/1,256C converter leaf itself passes 10/10 fixed-point cases, but its data-age grid resolves new data only by 760 ps and reaches 150 mV margin by 770 ps of an 800 ps lane cycle. | Input loading and routed composition are now measured. The remaining speed boundary is an explicit retimer or acquisition/write reschedule that creates one non-overlapping common data age in SS/hot; selecting separate lane latencies is not a valid closure. |
