...
| 1:2 deserializer | The original shared-clock cell remains physically closed, but full-lane composition showed that opposite-edge sampler decisions do not share a safe conversion window. Its 190 by 122 um independently clocked replacement is zero-DRC, uniquely LVS-matched, and now retapered to 1,957R/1,400C. The revised cell passes the full 1.25-GBd exact-PEX PVT/stress parent and closes both 2.5-GT/s fast-corner writes. | Statistical hold/metastability, extracted aggressors and post-fill extraction |
...
| Externally clocked lane spine | At 1.25 GBd, the exact TX/termination/RX/restorer/sampler/converter/capture stack passes 5/5 environments and 160/160 PRBS bits under simultaneous bounded channel, jitter, duty, and rail-ripple stress. A separate rate-specialized 3.6-um-load restorer is zero-DRC, uniquely LVS-matched, and 366R/92C full-RC extracted for 2.5 GT/s. One immutable release PEX stack passes 6/16 nominal phases and 5/5 representative environments at 2.5 GT/s. The complete 2.5-GT/s path passes nominal combined stress; a retapered 1,957R/1,400C capture cell and calibrated controls now close FF/cold and FF/hot as exact-PEX parents. The original 1/5 PVT replay remains immutable provenance, while new evidence proves 2/2 repaired fast corners. | Physically revise TX drive/emphasis for the two slow/hot combined-stress cases, then add mismatch, extracted parent routing and simultaneous substrate/PDN aggression before replacing the proxy with selected I/O models. |
