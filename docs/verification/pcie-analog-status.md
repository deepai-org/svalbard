...
| Externally clocked lane spine | The selected serializer/TX full-RC extraction drives an explicit AC-coupled provisional boundary and fresh termination/RX/sampler PEX. Two exact-PEX converters and the split-clock capture close nominal and 5-environment transfer to parallel CMOS. A denser combined matrix exposed an RX-to-sampler assumption violation, rejected the slower reused clock limiter, and produced a dedicated zero-DRC/unique-LVS 366R/92C data restorer. Its exact PEX plus the unchanged lane stack passes 5/5 environments and 160/160 scored PRBS bits under simultaneous 6-ohm/leg + 1-pF channel stress, 30-ps peak jitter, 47% duty, and 20-mV/100-MHz rail ripple. Worst TX/pin/raw-RX/restored/converter/capture margins are 78.681/147.603/50.674/230.118/2578.62/2733.72 mV; current is 26.38--41.44 mA. | Add mismatch and simultaneous extracted supply/substrate aggression, repeat at 2.5 GT/s, then replace the proxy with selected pad/ESD/package/S-parameter models. |
...
1. Add mismatch and simultaneous extracted supply/substrate aggression to the
   closed 1.25-GBd combined-stress lane. Reconcile complete-path power before
