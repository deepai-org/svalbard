...
1. Integrate the physically closed direct-regenerative RX/capture replacement
   with the phase interpolator and clock restorer, then re-establish 5/5
   exact-parent closure without per-corner data-age selection.
2. Realize the non-overlapping sense/write pulse generator, upstream clock and
