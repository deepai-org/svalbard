...
| Externally clocked lane spine | At 1.25 GBd, the exact TX/termination/RX/restorer/sampler/converter/capture stack passes 5/5 environments and 160/160 PRBS bits under simultaneous bounded channel, jitter, duty, and rail-ripple stress. A separate rate-specialized 3.6-um-load restorer is zero-DRC, uniquely LVS-matched, and 366R/92C full-RC extracted for 2.5 GT/s. One immutable release PEX stack passes 6/16 nominal phases and 5/5 representative environments at 2.5 GT/s; worst selected raw-RX hold/restored/sampler margins are 169.915/376.508/137.055 mV. Slow/hot cases incur one deterministic UI of pipeline latency. Automated evidence checks bind the exact simulated bytes to physical records despite nondeterministic extractor ordering. | Add the combined channel/jitter/supply stress matrix and mismatch at 2.5 GT/s, extracted parent routing and simultaneous substrate/PDN aggression, then replace the proxy with selected pad/ESD/package/S-parameter models. |
