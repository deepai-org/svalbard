...
1. Realize the non-overlapping sense/write pulse generator after the physically
   closed PI/restorer/rail-converter path, drive the actual extracted
   direct-regenerative clock gates, and re-establish 5/5 exact-parent closure.
