...
| Dual-edge sense/write pulse generator | The reset-dominant interval-latch topology is now a 422-MOS, 498.0 by 285 um stacked-phase layout with 0 DRC, unique pin-resolved LVS, and 9,320R/6,057C exact extraction. Dedicated parent-strapped write-source and sense-source supply pins remove the false single-point-PDN assumption while device bodies remain on the continuous global rails. Nominal exact PEX now passes the entire contract: EVEN/ODD sense 576.84/581.83 ps, write 218.29/110.83 ps, delay 657.45 ps, non-overlap 80.61 ps, phase spacing 395.18 ps, rail extrema at least 3.065 V and at most 0.214 V, and 74.697 mA. The full 20-case exact-PVT matrix passes 1/20 cases and covers TT only; FF/cold is current/width limited, fast/hot and SS/hot lose restoration, and SS/cold loses WRITE events. The schematic profile matrix remains 0/5 environments. Parallel bounded simulation now runs four independent cases on four CPUs. | Add physically realized fast/hot and slow-corner profiles, reduce FF/cold current, widen the narrow TT margins, then compose the extracted pulse macro with the rail converter and actual capture gates. |
