...
| Externally clocked lane spine | At 1.25 GBd, the exact TX/termination/RX/restorer/sampler/converter/capture stack passes 5/5 environments and 160/160 PRBS bits under simultaneous bounded channel, jitter, duty, and rail-ripple stress. At 2.5 GT/s, one zero-DRC, unique-LVS, 7,900R/4,804C receive parent now contains termination, RX, calibrated restorer, sampler, both converters, split capture, and their data/capture-clock routes. Its exact PEX passes 5/5 representative environments over 24-bit PRBS7 with 6 ohm/leg plus 1 pF loading, 30 ps peak TX jitter, 47% duty cycle, and 20 mV peak 100 MHz rail ripple. Worst pin, raw-RX, restored, converter, and final margins are 104.176 mV, 47.052 mV, 209.582 mV, 558.084 mV, and 623.576 mV; maximum current is 52.203 mA. A new 8,625R/5,034C zero-DRC, unique-LVS parent routes the PI through a two-stage clock restorer into this hierarchy. Its nonlinear clock-load chain passes and sampler/converter boundaries close after common-mode calibration, but the odd final capture peaks near 0.41 V against the 0.50 V contract. The result is retained as a localized failure, not promoted as a passing lane. | Rebalance/strengthen the odd capture branch, replay full 24-bit/PVT evidence, then add statistical mismatch/noise and metastability, realized pulse/bias generation, package/pad/channel EM, simultaneous substrate/PDN aggression, fill, EM/IR, and provider signoff models. |
...
1. Add provider-qualified mismatch/noise and simultaneous extracted supply and
