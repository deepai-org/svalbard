...
1. Compose an entire externally clocked 1.25 GBd PRBS loopback lane around the
   closed integrated serializer/TX. Reconcile complete-path timing and power
   before extending more autonomous leaves.
