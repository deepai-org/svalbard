...
| Dual-edge sense/write pulse generator | The reset-dominant interval-latch topology is now a 424-MOS, 498.0 by 285 um stacked-phase layout with 0 DRC, unique pin-resolved LVS, and 9,278R/6,039C exact extraction. Dedicated parent-strapped write/sense supplies and profile-3 `CLKP_H`/`CLKN_H` taps remove false single-point assumptions while device bodies remain on continuous global rails. Nominal exact PEX passes the entire contract: EVEN/ODD sense 573.54/584.08 ps, write 210.12/134.72 ps, delay 669.94 ps, non-overlap 96.40 ps, phase spacing 391.30 ps, rail extrema at least 3.122 V and at most 0.215 V, and 74.514 mA. The hot tap now reaches 2.234/2.245 V at FF/hot and 1.946/1.953 V at SS/hot, but downstream restoration still leaves the full exact matrix at 1/20 cases and TT-only coverage. The schematic matrix gains the FF/hot profile but still covers only 1/5 environments. | Close downstream hot/slow restoration and FF/cold current/width, widen TT margins, then compose the extracted pulse macro with the rail converter and actual capture gates. |
