...
| Externally clocked lane spine | The selected serializer/TX full-RC extraction now drives an explicit AC-coupled provisional boundary, freshly regenerated zero-DRC/unique-LVS/full-RC termination, RX amplifier, and dual-edge sampler. The nominal 1.25 GBd composition completes 16/16 phase cases and passes 13; its best phase retains 259.8 mV pin, 300.4 mV amplifier, and 1.345 V held-sampler margin. The same phase passes 5/5 representative environments with 225.8/124.0/305.0 mV respective worst margins and 9.82--16.13 mA shared current. | Add two extracted CML-to-CMOS decisions, parallel capture and PRBS scoreboard; then sweep channel loss, jitter, duty distortion, mismatch and simultaneous supply/substrate aggression. Replace the provisional boundary with selected pad/ESD/package/channel models. |
...
1. Extend the closed extracted 1.25 GBd TX-to-held-sampler spine through two
   real CML-to-CMOS decisions, parallel capture and a PRBS scoreboard. Reconcile
