...
| Dual-edge sense/write pulse generator | The reset-dominant interval-latch topology is now a 428-MOS, 499.6 by 285 um stacked-phase layout with 0 DRC, unique pin-resolved LVS, and 9,344R/6,103C exact extraction. Dedicated parent-strapped write/sense supplies and profile-3 `CLKP_H`/`CLKN_H` taps remove false single-point assumptions while device bodies remain on continuous global rails. Nominal exact PEX passes the entire contract: EVEN/ODD sense 563.33/596.37 ps, write 168.31/174.38 ps, delay 680.76 ps, non-overlap 117.43 ps, phase spacing 370.16 ps, rail extrema at least 3.127 V and at most 0.182 V, and 70.080 mA. Profile-3 `P06S/P09S` now reach 2.649/2.622 V at FF/hot and 2.644/2.652 V at SS/hot; FF/hot produces two rail-level write events and SS/hot one, but sense and width failures leave the full exact matrix at 1/20 cases and TT-only coverage. The ideal-interconnect matrix is 0/20 and is retained separately. | Close hot sense propagation and profile-3 width/phase alignment, then FF/cold current and SS/cold width; compose the extracted pulse macro with the rail converter and actual capture gates only after multi-corner closure. |
