...
def group_depths(groups: dict[str, Group], phase: str) -> dict[str, int]:
    ...
    inputs.update({
        ...
        "cp_cond_npd_comp": ("G", "EN"),
              ...
              "cp_sense_stretch": ("A", "B"),
              "cp_stretch_enable": ("A", "EN"),
        "cp_fall_window": ("A", "B"),
    ...
    for lane in range(LANE_COUNT):
        ...
        if lane == 2:
            ...
            sense_rank = {
                ...
                "XSTATE": 19, "XLC0": 20, "XLC1": 21, "XLC2": 22,
                "XLC3": 23, "XLB2": 24, "XLS2": 24,
                "XLS3": 25, "XSB2": 26,
                "XSI0": 20, "XSI1": 21,
                "XRB1": 20, "XRBB": 21,
        ...
        if lane == 3:
            ...
            if any(instance_root(group.name) == "XTD0" for group in selected):
                ...
                selector_rank.update({
                    ...
                    "XWB3": 27, "XWB4": 28,
                    "XWCLKIF0": 29, "XWCLKIF1": 30,
                    "XWCLKBIF0": 31, "XWCLKBIF1": 32,
                })
...
def emit(source: Path, output: Path, top_name: str = "clock_pulse_generator") -> None:
    ...
    debug_labels = {
        ...
        "XE__LC0B": "DBG_E_LC0B", "XE__LC1": "DBG_E_LC1",
        "XE__LC2B": "DBG_E_LC2B",
        "XE__LCB": "DBG_E_LCB", "XE__LSTATE": "DBG_E_LSTATE",
        ...
        "__E_SENSE_SRC": "DBG_E_IF_SENSE_SRC",
        "XE_IF__SENSE_B": "DBG_E_IF_SENSE_B",
        "__E_BOOST_SRC": "DBG_E_IF_BOOST_SRC",
        "XE_IF__BOOST_B": "DBG_E_IF_BOOST_B",
        "__E_CAPTURE_CLK_SRC": "DBG_E_IF_CLK_SRC",
        "XE_IF__CLK_B": "DBG_E_IF_CLK_B",
        "__E_CAPTURE_CLKB_SRC": "DBG_E_IF_CLKB_SRC",
        "XE_IF__CLKB_B": "DBG_E_IF_CLKB_B",
        ...
        "XO__P08": "DBG_O_P08",
        "XO__PCLK": "DBG_O_PCLK",
        "__O_SENSE_SRC": "DBG_O_IF_SENSE_SRC",
        "XO_IF__SENSE_B": "DBG_O_IF_SENSE_B",
        "__O_BOOST_SRC": "DBG_O_IF_BOOST_SRC",
        "XO_IF__BOOST_B": "DBG_O_IF_BOOST_B",
        "__O_CAPTURE_CLK_SRC": "DBG_O_IF_CLK_SRC",
        "XO_IF__CLK_B": "DBG_O_IF_CLK_B",
        "__O_CAPTURE_CLKB_SRC": "DBG_O_IF_CLKB_SRC",
        "XO_IF__CLKB_B": "DBG_O_IF_CLKB_B",
        "XO__D08": "DBG_O_D08",
        ...
        "XO__LC0B": "DBG_O_LC0B", "XO__LC1": "DBG_O_LC1",
        "XO__LC2B": "DBG_O_LC2B",
        "XO__LCB": "DBG_O_LCB", "XO__LSTATE": "DBG_O_LSTATE",
