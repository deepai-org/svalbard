...
# Compact mirror-symmetric GF180 CML-clock level converter.
...
array set tracks {
    VSS -34.0 INP -24.0 INN -22.4 VBIAS -20.8
    TP -16.0 TN -14.4 AD -12.8 BD -11.2
    AP 9.6 AN 11.2 AB 12.8 NB 14.4 AC 16.0 NC 17.6
...
# The input and mirror-load quartets use D A | B D ordering with equal edge
# dummies.  The complete right half is the electrical mirror of the left.
set devices {
    {XDNL nfet_03v3 8 2 -30 0 VSS VSS VSS}
    {XAPN nfet_03v3 8 2 -18 0 AP INP TP}
    {XADN nfet_03v3 8 2 -6 0 AD INN TP}
    {XBDN nfet_03v3 8 2 6 0 BD INP TN}
    {XANN nfet_03v3 8 2 18 0 AN INN TN}
    {XDNR nfet_03v3 8 2 30 0 VSS VSS VSS}
    {XATP nfet_03v3 10 4 -12 -18 TP VBIAS VSS}
    {XATN nfet_03v3 10 4 12 -18 TN VBIAS VSS}
    {XFNAP nfet_03v3 1 1 -22 10 AP AN VSS}
    {XAPN1 nfet_03v3 2 1 -46 18 AB AP VSS}
    {XAMN nfet_03v3 4 1 -38 18 AC AB VSS}
    {XOPN nfet_03v3 6 2 -30 18 OUTP AC VSS}
    {XONN nfet_03v3 6 2 30 18 OUTN NC VSS}
    {XNMN nfet_03v3 4 1 38 18 NC NB VSS}
    {XANN1 nfet_03v3 2 1 46 18 NB AN VSS}
    {XFNAN nfet_03v3 1 1 22 10 AN AP VSS}

    {XDPL pfet_03v3 4 2 -30 48 VDD VDD VDD}
    {XAPP pfet_03v3 4 2 -18 48 AP AD VDD}
    {XADP pfet_03v3 4 2 -6 48 AD AD VDD}
    {XBDP pfet_03v3 4 2 6 48 BD BD VDD}
    {XANP pfet_03v3 4 2 18 48 AN BD VDD}
    {XDPR pfet_03v3 4 2 30 48 VDD VDD VDD}
    {XFPAP pfet_03v3 3 1 -22 40 AP AN VDD}
    {XAPP1 pfet_03v3 4 1 -46 58 AB AP VDD}
    {XAMP pfet_03v3 8 1 -38 58 AC AB VDD}
    {XOPP pfet_03v3 12 2 -30 58 OUTP AC VDD}
    {XONP pfet_03v3 12 2 30 58 OUTN NC VDD}
    {XNMP pfet_03v3 8 1 38 58 NC NB VDD}
    {XANP1 pfet_03v3 4 1 46 58 NB AN VDD}
    {XFPAN pfet_03v3 3 1 22 40 AN AP VDD}
}

crashbackups stop
load clock_level_converter
units microns
...
save /work/clock_level_converter
gds write /work/clock_level_converter.gds
quit -noprompt
