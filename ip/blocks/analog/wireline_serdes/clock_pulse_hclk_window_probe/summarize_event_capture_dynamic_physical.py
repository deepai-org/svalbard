#!/usr/bin/env python3
"""Create the physical record for the dynamic-state event bridge."""
...
import compile_event_capture_dynamic_physical_source as compiler
import compile_event_capture_dynamic_state as event_source
...
result = {
    "schema_version": 1,
    "claim": "retimed_dynamic_state_event_capture_bridge_physical_legality",
    "scope": "generated dynamic-state event/bridge layout, native Magic DRC, "
