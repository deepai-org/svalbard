#!/usr/bin/env python3
"""Create the hash-joined physical-legality record for the event bridge."""
...
import compile_event_capture_physical_source as compiler
...
result = {
    "schema_version": 1,
    "claim": "retimed_full_duty_event_capture_bridge_physical_legality",
    "scope": "generated combined event/bridge layout, native Magic DRC, "
