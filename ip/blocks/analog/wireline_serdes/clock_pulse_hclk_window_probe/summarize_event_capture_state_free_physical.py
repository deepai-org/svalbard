#!/usr/bin/env python3
"""Create the physical record for the state-free event/capture bridge."""
...
import compile_event_capture_state_free as event_source
import compile_event_capture_state_free_physical_source as compiler
...
result = {
    "schema_version": 1,
    "claim": "retimed_capture_state_free_event_bridge_physical_legality",
    "scope": "generated capture-owned START-assist/event/bridge layout, native "
             "Magic DRC, Netgen LVS, full-RC extraction, and review render",
    "top": compiler.TOP,
    ...
    "identity": {
        "admitted_source_sha256": digest(
            WORK / "retimed_capture_events_admitted.spice"),
