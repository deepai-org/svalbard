...
set devices {
    ...
    {XESETC nfet_03v3 8 8 -42 -5 E_SET_TAIL CAPTURE_CLK VSS}
    {XERSTD nfet_03v3 8 4 -42 -17 E_QI EVEN_DB_BUF E_RST_TAIL}
    {XERSTC nfet_03v3 8 8 -30 -17 E_RST_TAIL CAPTURE_CLK VSS}
    {XEQBN nfet_03v3 4 2 -66 22 E_QBBUF E_QI VSS}
    {XEQON nfet_03v3 8 6 -78 22 EVEN_Q E_QBBUF VSS}
    {XEBBN nfet_03v3 4 2 -12 22 E_QBUF E_QBI VSS}
    {XEBON nfet_03v3 8 6 -24 22 EVEN_QB E_QBUF VSS}
    ...
    {XOSETC nfet_03v3 8 8 42 -5 O_SET_TAIL CAPTURE_CLK VSS}
    {XORSTD nfet_03v3 8 4 42 -17 O_QI ODD_DB_BUF O_RST_TAIL}
    {XORSTC nfet_03v3 8 8 30 -17 O_RST_TAIL CAPTURE_CLK VSS}
    {XOQBN nfet_03v3 4 2 66 22 O_QBBUF O_QI VSS}
    {XOQON nfet_03v3 8 6 78 22 ODD_Q O_QBBUF VSS}
    {XOBBN nfet_03v3 4 2 12 22 O_QBUF O_QBI VSS}
    {XOBON nfet_03v3 8 6 24 22 ODD_QB O_QBUF VSS}
    ...
    {XESETPC pfet_03v3 8 8 -30 50 E_PSET_TAIL CAPTURE_CLKB VDD}
    {XERSTPD pfet_03v3 8 4 -42 76 E_QBI EVEN_D_BUF E_PRST_TAIL}
    {XERSTPC pfet_03v3 8 8 -30 76 E_PRST_TAIL CAPTURE_CLKB VDD}
    {XEQBP pfet_03v3 8 2 -66 50 E_QBBUF E_QI VDD}
    {XEQOP pfet_03v3 8 8 -78 66 EVEN_Q E_QBBUF VDD}
    {XEBBP pfet_03v3 8 2 -12 50 E_QBUF E_QBI VDD}
    {XEBOP pfet_03v3 8 8 -24 66 EVEN_QB E_QBUF VDD}
    ...
    {XOSETPC pfet_03v3 8 8 30 50 O_PSET_TAIL CAPTURE_CLKB VDD}
    {XORSTPD pfet_03v3 8 4 42 76 O_QBI ODD_D_BUF O_PRST_TAIL}
    {XORSTPC pfet_03v3 8 8 30 76 O_PRST_TAIL CAPTURE_CLKB VDD}
    {XOQBP pfet_03v3 8 2 66 50 O_QBBUF O_QI VDD}
    {XOQOP pfet_03v3 8 8 78 66 ODD_Q O_QBBUF VDD}
    {XOBBP pfet_03v3 8 2 12 50 O_QBUF O_QBI VDD}
    {XOBOP pfet_03v3 8 8 24 66 ODD_QB O_QBUF VDD}
}

crashbackups stop
load deserializer_1to2
units microns
...
foreach {name number x} {EVEN_D 1 -93 EVEN_DB 2 -91 ODD_D 3 91 ODD_DB 4 93 CAPTURE_CLK 5 -89 CAPTURE_CLKB 6 89 EVEN_Q 9 -87 EVEN_QB 10 -85 ODD_Q 11 85 ODD_QB 12 87} {
...
foreach {name number x} {VDD 7 -83 VSS 8 83} {
    connect_net $name $x $tracks($name)
    via_at via4 $x $tracks($name)
...
paint_rect metal5 83.0 -69.98 94.98 -69.22
paint_rect metal5 82.62 -69.6 83.38 -30.0

save /work/deserializer_1to2
gds write /work/deserializer_1to2.gds
quit -noprompt
