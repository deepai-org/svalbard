...
layout = pya.Layout()
layout.read("/work/deserializer_1to2.gds")
top = layout.top_cell()
bbox = top.bbox()
...
draw.text((32, 27),
          f"GF180 differential 1:2 capture | {bbox.width() * layout.dbu:.1f} x "
          f"{bbox.height() * layout.dbu:.1f} um | DRC/LVS clean | PEX: 2236 R / 1564 C",
...
annotate("symmetric cross-coupled capture cores", 0, 10, (189, 103, 217, 255))
annotate("isolated complementary outputs", 62, 52, (61, 214, 255, 255))
annotate("contacted substrate guard ring", 0, -69.6, (255, 92, 92, 255))

canvas.convert("RGB").save("/work/deserializer-layout.png", quality=94)
