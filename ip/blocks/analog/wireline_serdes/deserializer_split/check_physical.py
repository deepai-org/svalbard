#!/usr/bin/env python3
"""Check the independently clocked dual-capture physical views."""
...
print(f"split capture physical: {result['result']}; {result['drc_error_count']} DRC; "
      f"{checks['lvs_unique']} LVS; {resistors}R/{capacitors}C")
