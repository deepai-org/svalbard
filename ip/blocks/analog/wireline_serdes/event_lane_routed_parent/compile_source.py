...
def compile_source() -> str:
    ...
    parent = f"""
* Namespace-safe composed transistor intent. Regenerative clock ports are
* intentionally tied inactive; static BOOST is the selected measured trim.
...
+ VTHP VTHN RX_BIAS RX_BW_EN_N VDD VSS
...
+ E_SENSE VSS VSS E_CAPTURE_CLK E_CAPTURE_CLKB VDD
+ O_SENSE VSS VSS O_CAPTURE_CLK O_CAPTURE_CLKB VDD
