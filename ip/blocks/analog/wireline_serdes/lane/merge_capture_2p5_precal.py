#!/usr/bin/env python3
"""Preserve the pre-calibration 2.5 GT/s combined-stress mechanisms."""
...
result = {
    "schema_version": 1,
    "claim": "precalibration_2p5_gts_combined_stress_pvt",
...
print(f"2.5 GT/s combined-stress pre-calibration: "
