#!/usr/bin/env python3
"""Render the generated phase-interpolator GDS for physical review."""
...
layout = pya.Layout()
layout.read("/work/phase_interpolator.gds")
top = layout.top_cell()
bbox = top.bbox()
...
ImageDraw.Draw(canvas).text((MARGIN, 15),
    f"GF180 phase_interpolator | {bbox.width() * layout.dbu:.1f} x {bbox.height() * layout.dbu:.1f} um",
    fill=(235, 239, 245, 255))
canvas.convert("RGB").save("/work/phase_interpolator-layout.png")
