...
# Two vertically composed, independently guarded CML limiter stages.
...
crashbackups stop
load cml_clock_restorer_cascade_hier
units microns
getcell cml_clock_restorer child 0 0 parent 0 0
identify XPRE
getcell cml_clock_restorer child 0 0 parent 0 47
identify XDRV
select top cell
flatten cml_clock_restorer_cascade
load cml_clock_restorer_cascade
units microns
...
save /work/cml_clock_restorer_cascade
gds write /work/cml_clock_restorer_cascade.gds
quit -noprompt
