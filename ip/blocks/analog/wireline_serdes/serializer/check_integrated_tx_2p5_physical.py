#!/usr/bin/env python3
"""Bind the rate-specialized integrated serializer/TX physical views."""
...
checks = {
    ...
    "full_rc": resistors >= 900 and capacitors >= 500,
    "rendered": args.render.stat().st_size >= 10_000,
}
result = {
    "schema_version": 1,
    "claim": "physical_rate_specialized_2p5_gts_integrated_serializer_tx",
    "checks": checks,
...
print(f"2.5-GT/s integrated TX physical: {result['result']}; "
