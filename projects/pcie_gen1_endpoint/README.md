...
The current top-down implementation audit, including the corrected
external-clock-first integration order and unresolved clock/power decisions, is
the [PCIe architecture checkpoint](../../docs/verification/pcie-architecture-checkpoint.md).
