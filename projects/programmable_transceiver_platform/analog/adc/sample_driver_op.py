...
def main(headroom=False):
 circuit='sample_driver_headroom' if headroom else 'sample_driver'
 O=Path('/work');rows=[]
...
VIP IP 0 {cm+.2}
VIN IN 0 {cm-.2}
XP IP OP BN BP VDD 0 pt_{circuit}
XN IN ON BN BP VDD 0 pt_{circuit}
.control
set wr_singlescale
set wr_vecnames
set numdgt=15
