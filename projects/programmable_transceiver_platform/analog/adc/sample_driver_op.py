...
.include /screen/adc/sample_driver.spice
.temp 27
VDD VDD 0 3.3
IBN VDD BN 20u
IBP BP 0 20u
...
VIP IP 0 {cm+.2}
VIN IN 0 {cm-.2}
XP IP OP BN BP VDD 0 pt_sample_driver
XN IN ON BN BP VDD 0 pt_sample_driver
.control
set wr_singlescale
set wr_vecnames
set numdgt=15
