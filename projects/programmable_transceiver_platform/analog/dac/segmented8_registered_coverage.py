...
manifest=dict(source_sha256_before=before,planned_cases=['c32_skew0.2','c128_skew-0.2','c128_skew0','c128_skew0.2'],extra_vectors=extra,clock_fixture='PULSE first6ns,period25ns,width5ns,100ps edges; reset release2ns',scope='Fixed capture opportunity ~1ns after nominal command onset; not setup/hold qualification')
