...
(O/'change-manifest.json').write_text(json.dumps(dict(changes=changes,scope='Only four mirror FET W/L pairs doubled; all multiplicities, targets, biases and compensation retained.'),indent=2)+'\n')
