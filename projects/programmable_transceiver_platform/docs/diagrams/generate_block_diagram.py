...
for y,ch,lo in [(695,'I','LO-I'),(905,'Q','LO-Q')]:
    ...
    filter_(930,y,'5-pole LPF; 9.16 MHz');wire([(820,y),(878,y)])
...
label(100,26280,'Model and RTL still need the mode interlock and transition tests. Historical simultaneous traffic is optional stress evidence.',19,anchor='start')
...
focused='\n'.join(A).replace('height="26600" viewBox="0 0 2600 26600"','height="1750" viewBox="0 23500 2600 1750"',1)
