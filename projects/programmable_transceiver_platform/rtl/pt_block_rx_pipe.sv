...
module pt_block_rx_pipe(input wire clk,rst_n,mode8,in_valid,input wire[79:0]words,
 ...
 pt_block_route route(mode8,allowed,beat,stage_words,beat==0?stage_wc:leftw,beat==0?stage_qc:leftq,wdata,qdata,wn,qn,nw,nq);
