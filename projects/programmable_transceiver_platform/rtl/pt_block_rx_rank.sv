...
module pt_block_rx_rank(input wire clk,rst_n,mode8,in_valid,input wire[79:0]words,
 ...
 pt_block_route_rank route(allowed,wire_slots,iq_slots,stage_words,beat==0?stage_wc:leftw,beat==0?stage_qc:leftq,wdata,qdata,wn,qn,nw,nq);
