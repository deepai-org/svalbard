// Shared control body; caller defines PT_RX_MODULE and PT_RX_ROUTE.
...
module `PT_RX_MODULE(input wire clk,rst_n,mode8,in_valid,input wire[79:0]words,
 ...
 `PT_RX_ROUTE route(allowed,wire_slots,iq_slots,stage_words,beat==0?stage_wc:leftw,beat==0?stage_qc:leftq,wdata,qdata,wn,qn,nw,nq);
