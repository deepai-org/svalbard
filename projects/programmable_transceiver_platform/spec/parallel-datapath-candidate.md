...
qualified asynchronous bundled-data crossing. Add routed delay/skew and hold
constraints after that derivation; positive nominal slack alone is insufficient.
