"""Fast harness fork of connected/sustained_lifecycle.py: permits timed preparation.

Only additions: prepare callback, current-time configuration and relative startup
deadline, plus fixed optional startup settling. Kept outside frozen connected sources while detailed runs are active.
"""
