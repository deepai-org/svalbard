...
"""Fast TX calibration adapter forked from connected/tx_calibration_chip.py.

Uses ServiceChip sampled-clock readiness instead of physical coarse-bank search.
Kept separate while detailed connected sources are frozen by live simulations.
...
class FastTxServiceChip(ServiceChip):
