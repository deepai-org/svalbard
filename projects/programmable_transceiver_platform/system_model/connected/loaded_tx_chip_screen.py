...
def main():
    c=LoadedTxChip(watchdog_s=1e-3,dac_latency_s=100e-9,tx_relative_gain=True)
    ...
    (P/'evidence/connected-loaded-tx-chip.json').write_text(json.dumps(report,indent=2)+'\n');print(report)
