...
def main():
    ...
    c=ManagedDenseReferenceChip(resistance=50.,reference_source_limit_a=150e-6,reference_sink_limit_a=150e-6,adc_latency_s=30e-9,tx_relative_gain=True,watchdog_s=1e-3)
    ...
    (P/'evidence/connected-managed-dense-calibration.json').write_text(json.dumps(report,indent=2)+'\n')
