...
def main():
    ...
    c=ManagedUnifiedReferenceChip(adc_latency_s=30e-9,tx_relative_gain=True,watchdog_s=1e-3)
    ...
    (P/'evidence/connected-managed-unified-calibration.json').write_text(json.dumps(report,indent=2)+'\n')
