...
def main():
    ...
    report=dict(status='passed' if passed else 'failed',quality_pass=passed,
        ...
        '20us settling and26us traffic preparation; source duration extends through every captured sample.','Detection precedes traffic because detection and wired TX share pads.',
    ...
    (P/'evidence/connected-pulse-wideband-quality.json').write_text(json.dumps(report,indent=2)+'\n')
