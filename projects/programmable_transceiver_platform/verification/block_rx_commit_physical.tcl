...
link_design pt_block_rx_commit
# A local 400 x 400 um digital region, not the whole chip's floorplan.
initialize_floorplan -site GF018hv5v_mcu_sc7 -die_area {0 0 420 420} -core_area {10 10 410 410}
make_tracks
...
puts $file "{\"instances\": $count, \"cell_area_um2\": $area, \"unplaced\": $unplaced, \"requested_region_um2\": 160000}"
close $file
