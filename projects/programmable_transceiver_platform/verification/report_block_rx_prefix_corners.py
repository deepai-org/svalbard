...
root=pathlib.Path(__file__).resolve().parents[3];p=root/'projects/programmable_transceiver_platform';out=root/'scratch/transceiver-block-rx-prefix-corners'
prior=json.loads((p/'evidence/block-rx-prefix-mapping.json').read_text());name='scratch/transceiver-block-rx-prefix-mapping/mapped.v'
