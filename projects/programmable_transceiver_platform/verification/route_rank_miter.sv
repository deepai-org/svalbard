module route_rank_miter(input allow_payload,input[7:0]wire_slots,iq_slots,
 ...
 pt_block_route_rank b(allow_payload,wire_slots,iq_slots,words,left_wire,left_iq,bw,bq,bc,bd,bn,bm);
