...
import numpy as np
from run_adc_kickback import run_cases

def main():
    R = Path(__file__).resolve().parents[3]
    P = R / 'projects/programmable_transceiver_platform'
    parser = argparse.ArgumentParser()
    parser.add_argument('--cdac', action='store_true')
