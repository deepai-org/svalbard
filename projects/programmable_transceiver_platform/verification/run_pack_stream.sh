...
OUT="$ROOT/scratch/transceiver-pack-stream"
mkdir -p "$OUT"
...
set -eu
iverilog -g2012 -s tb_pack_stream -o /out/pack /src/rtl/pt_pack.sv /src/sim/tb_pack_stream.sv
vvp /out/pack
python3 /src/verification/pack_negative_controls.py'
