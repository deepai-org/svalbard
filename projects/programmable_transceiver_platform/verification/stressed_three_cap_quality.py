...
if __name__ == '__main__':
    ...
    path = P / f'evidence/stressed-three-cap-quality-mode{args.mode}-launch.json'
    path.write_text(json.dumps(report, indent=2) + '\n')
    try:
        main(args.mode, True, actual_chip_class=StressedChip, experiment_tag='three-cap-stressed-repeated-cal')
        result_path = P / f'evidence/connected-limited-rail20-pad-quality-mode{args.mode}-three-cap-stressed-repeated-cal-phase-diagnostic.json'
