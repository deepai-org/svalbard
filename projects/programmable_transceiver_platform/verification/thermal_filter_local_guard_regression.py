...
def main():
    ...
    files=[Path(__file__)]+[P/'verification'/f for f in ('thermal_filter_batched.py','thermal_filter_guard_screen.py','thermal_filter_local_guard.py',
    ...
    (P/'evidence/thermal-filter-local-guard-regression.json').write_text(json.dumps(report,indent=2)+'\n')
