...
def structure() -> None:
    required = [
        ...
        "scripts/test_analyze_pex_net.py",
        "ip/blocks/analog/wireline_serdes/analog_evidence.py",
        "ip/blocks/analog/wireline_serdes/clock_pulse/check_pulse_checkpoint.py",
        "ip/blocks/analog/wireline_serdes/clock_pulse/pulse_layout.png",
        "ip/blocks/analog/wireline_serdes/clock_pulse/pulse_schematic_result.json",
        "ip/blocks/analog/wireline_serdes/clock_pulse/pulse_pex_nominal_result.json",
        "ip/blocks/analog/wireline_serdes/clock_pulse/pulse_pex_pvt_result.json",
        ...
        "env/images/quaigh-atpg/Dockerfile",
        ...
        "flows/smoke/digital_pnr/scan_to_bench.py",
        ...
        "flows/smoke/digital_pnr/transition_fault.py",
    ]
